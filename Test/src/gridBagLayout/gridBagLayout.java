...
public class gridBagLayout extends JFrame {
	...
	public gridBagLayout() {
		...
		scrollPane.setBounds(0, 0, 615, 373);
		contentPane.add(scrollPane);
		
		JPanel panel = new JPanel();
		scrollPane.setViewportView(panel);
		GridBagLayout gbl_panel = new GridBagLayout();
		gbl_panel.columnWidths = new int[]{166, 401, 0};
		gbl_panel.rowHeights = new int[]{36, 308, 37, 0};
		...
		JLabel lblNewLabel_1 = new JLabel("New labeaksjdkl");
